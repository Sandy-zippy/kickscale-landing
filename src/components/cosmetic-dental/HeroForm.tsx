...
const WEBHOOK_URL =
  import.meta.env.VITE_DENTAL_WEBHOOK_URL ||
  'https://sandyautomations.app.n8n.cloud/webhook/dental-lp'

const VOLUME_OPTIONS = [
  '<5 makeovers / mo (early-stage)',
  '5–15 makeovers / mo (growing)',
  '15–30 makeovers / mo (established)',
  '30+ makeovers / mo (multi-doctor / chain)',
]
...
export default function HeroForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      vertical: 'cosmetic-dental',
      source: 'hero_form',
      city: 'Hyderabad',
      clinic_name: fd.get('clinic_name'),
      whatsapp: fd.get('whatsapp'),
      monthly_volume: fd.get('monthly_volume'),
    ...
    try {
      ...
      console.error('Dental form submit error', err)
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <input id="clinic_name" name="clinic_name" required className={fieldClass} placeholder="e.g., FMS Dental, Banjara Hills" />
      </div>
      ...
      <div>
        <label htmlFor="monthly_volume" className={labelClass}>Makeovers / veneers booked each month today</label>
