...
const MONTHS = [
  ...
  { label: 'Month 1', cycles: 18, status: 'in-progress' as const },
  { label: 'Month 2', cycles: 28, status: 'in-progress' as const },
  { label: 'Month 3', cycles: 38, status: 'goal' as const },
]
      ...
      <div className="aspect-[4/3] w-full p-6 sm:p-8 flex flex-col">
        ...
        >
          <div className="flex items-baseline gap-2 mb-1.5">
            <div className="text-[10px] sm:text-xs tracking-[0.18em] uppercase font-bold text-[#2A2A35]/60">
              Your smile-makeover trajectory
            </div>
          ...
          >
            ...
            <span className="text-[#D5EB4B]"><AnimatedCounter target={38} /></span>{' '}
            <span className="text-base sm:text-lg font-normal text-[#5A5A66]">cases / month</span>
          </div>
          <div className="text-sm text-[#5A5A66] mt-1">
            +30 makeovers booked by Day 90.{' '}
        ...
        >
          ...
          <div className="text-xs sm:text-sm leading-tight">
            <span className="text-[#D5EB4B] font-bold font-mono">+₹30L revenue</span>{' '}
            <span className="text-[#FFFDF7]/70">at avg ₹1L makeover · paid for 15× over by sprint end</span>
          </div>
        </motion.div>
      </div>
