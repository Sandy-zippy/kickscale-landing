      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="md:col-span-9 text-4xl sm:text-5xl lg:text-6xl font-bold text-[#2A2A35] leading-[1.02] tracking-tight">
            ...
            <span className="text-[#2A2A35]/55">Three leaks between consult and case start are.</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="md:col-span-4 md:sticky md:top-32">
            ...
            <p className="text-sm font-mono uppercase tracking-wider text-[#2A2A35]/55">cost-per-case vs the CPL you see</p>
          </div>
          <blockquote className="md:col-span-8 text-2xl sm:text-3xl lg:text-4xl text-[#2A2A35] leading-[1.25] font-medium tracking-tight">
            &ldquo;200 selfies submitted. 12 makeovers started. The other 188{' '}
            <span className="bg-[#D5EB4B] px-1.5 -mx-1.5 box-decoration-clone">shopped 5 other clinics.</span>
            &rdquo;
            <footer className="mt-6 text-sm font-mono uppercase tracking-wider text-[#2A2A35]/55 not-italic">
              Pattern, Hyderabad solo dental owners
            </footer>
            <p className="mt-8 text-base text-[#5A5A66] font-normal leading-relaxed not-italic">
              You stop paying for selfie submissions. Every rupee tied to a case actually started. AI smile-preview qualifies before the consult.
            </p>
          </blockquote>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          >
            ...
            <div className="flex items-baseline gap-4 mb-5">
              ...
              <span className="text-sm font-mono uppercase tracking-wider text-[#2A2A35]/55">of consults walk out undecided</span>
            </div>
            <blockquote className="text-xl text-[#2A2A35] leading-snug font-medium mb-4">
              &ldquo;Spent 1 hour on a veneer plan. Patient said they&apos;d think about it. Never came back.&rdquo;
            </blockquote>
            <div className="text-[10px] font-mono uppercase tracking-wider text-[#2A2A35]/55 mb-6">
              Pattern, Indian cosmetic dentist owners
            </div>
            <p className="text-base text-[#5A5A66] leading-relaxed">
              We hand over an AI smile-preview tool, automated WhatsApp follow-up sequences, and EMI pre-approval workflows. Patients walk in already half-committed.
            </p>
          </motion.article>
          ...
          >
            ...
            <div className="flex items-baseline gap-4 mb-5">
              <span className="text-6xl sm:text-7xl font-bold text-[#2A2A35] font-mono leading-none">40%</span>
              <span className="text-sm font-mono uppercase tracking-wider text-[#2A2A35]/55">drop at financing</span>
            </div>
            <blockquote className="text-xl text-[#2A2A35] leading-snug font-medium mb-4">
              &ldquo;Patient commits to ₹1L makeover. EMI rejected. Deal dies right there.&rdquo;
            </blockquote>
            <div className="text-[10px] font-mono uppercase tracking-wider text-[#2A2A35]/55 mb-6">
              Practo + Justdial review patterns
            </div>
            <p className="text-base text-[#5A5A66] leading-relaxed">
              Pre-qualified EMI partners (Eduvanz, Fibe) integrated in your funnel. Approval before the chair, not after.
            </p>
          </motion.article>
        </div>
      </div>
