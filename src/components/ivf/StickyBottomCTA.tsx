          ...
          <div className="rounded-2xl bg-[#2A2A35] text-[#FFFDF7] shadow-[0_20px_50px_rgba(42,42,53,0.35)] border border-[#FFFDF7]/10 px-4 py-3 sm:px-5 sm:py-3.5 flex items-center gap-3 sm:gap-5 max-w-[640px] mx-auto">
            ...
            <div className="flex items-center gap-2 ml-auto flex-shrink-0">
              <a
                ...
                className="inline-flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2.5 min-h-[44px] rounded-md bg-[#D5EB4B] text-[#2A2A35] font-bold text-sm hover:bg-[#c2d942] transition-colors whitespace-nowrap"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-2 min-h-[44px] text-xs sm:text-sm font-semibold text-[#FFFDF7]/80 hover:text-[#D5EB4B] transition-colors whitespace-nowrap"
              >
                ↑ Apply
              </button>
            </div>
