...
export default function HairTransplantFinalCTA() {
  return (
    <section className="bg-[#FFFDF7] relative overflow-hidden py-32 sm:py-40 px-6 border-t border-[#2A2A35]/10">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-100px' }} transition={{ duration: 0.6 }} className="relative max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-[#2A2A35] leading-[1.02] tracking-tight mb-6">
          See your 90-day transplant target,{' '}
        ...
        <p className="text-lg text-[#5A5A66] max-w-2xl mx-auto mb-10 leading-relaxed">
          Free audit. Custom transplant-volume target. ₹2L locked forever for the first 3 Hyderabad hair clinics. <span className="text-[#2A2A35] font-semibold">We refund you if we don&apos;t deliver.</span>
        </p>
        ...
        <div className="mt-16 pt-8 border-t border-[#2A2A35]/15 text-sm text-[#9CA3AF] flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <span className="inline-flex items-center min-h-[44px] px-2">ZippyScale · Hyderabad</span><span aria-hidden>·</span>
          <a href="https://zippyscale.in" className="inline-flex items-center min-h-[44px] px-2 hover:text-[#2A2A35]">zippyscale.in</a><span aria-hidden>·</span>
