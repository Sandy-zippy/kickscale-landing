    ...
    <CaseStudyLayout metadata={meta}>
      ...
      <section id="pain" className="py-16 px-4 bg-white border-y border-[#E5E7EB]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
          ...
          <div>
            <WhatsAppChaosMockup beforeMessages={beforeMessages} afterMessages={afterMessages} profile={{ name: 'Dr Clinic · WhatsApp', initials: 'Dr' }} />
          </div>
        </div>
      </section>
          ...
          <AuditTimeline
            steps={[
              ...
              },
              {
                ...
                description: 'A short PDF: the 3 biggest leaks we found, target outcomes per leak, and the exact 4-week sprint scope priced at ₹2L. No fluff, no upsell.',
              },
              {
                hour: '∞',
